...
async function simulateOrderJourney2(brand, orderId, items) {
  ...
  const orderEvents = [
    ...
    { status: 'OrderPicked', code: 12, eta: 18, location: locations[1] },
    { status: 'OrderPicked', code: 7, eta: 16, location: locations[2] },
    { status: 'OrderPicked', code: 7, eta: 14, location: locations[3] },
    { status: 'OrderPicked', code: 7, eta: 12, location: locations[4] },
    { status: 'OrderPicked', code: 7, eta: 10, location: locations[5] },
    { status: 'OrderPicked', code: 7, eta: 9, location: locations[6] },
    { status: 'OrderPicked', code: 7, eta: 8, location: locations[7] },
    { status: 'OrderPicked', code: 7, eta: 6, location: locations[8] },
    { status: 'OrderPicked', code: 7, eta: 4, location: locations[9] },
    { status: 'OrderPicked', code: 7, eta: 4, location: locations[10] },
    { status: 'OrderPicked', code: 7, eta: 3, location: locations[11] },
    { status: 'OrderPicked', code: 7, eta: 3, location: locations[12] },
    { status: 'OrderPicked', code: 7, eta: 3, location: locations[13] },
    { status: 'OrderPicked', code: 13, eta: 2, location: locations[14] },
    { status: 'Delivered', code: 8, eta: 0, location: locations[15] },
  ];
